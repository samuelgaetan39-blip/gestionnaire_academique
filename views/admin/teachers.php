                        ...
                        <form method="GET" class="d-flex align-items-center gap-2">
                            <div class="search-bar flex-grow-1">
                                ...
                                <input type="text" class="form-control" name="search" 
                                    placeholder="Rechercher par nom, e-mail ou spécialisation..." 
                                ...
                                <tbody>
                                    <?php while ($row = $teachers->fetch(PDO::FETCH_ASSOC)): ?>
                                        <tr>
                                            ...
                                            <td><span class="badge bg-success"><?= htmlspecialchars($row['specialization']) ?></span></td>
                                            <td><?= htmlspecialchars($row['phone']) ?></td>
                                            <td class="text-end">
                                                <button class="btn btn-sm btn-outline-primary" onclick='editTeacher(<?= json_encode($row) ?>)'>
                                                    <i class="bi bi-pencil"></i>
                                                </button>
                                                <a href="../../controllers/TeacherController.php?action=delete&id=<?= $row['id'] ?>" 
